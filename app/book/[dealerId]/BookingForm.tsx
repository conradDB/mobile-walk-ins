    ...
    <div className="wrap">
      ...
      {scanMode === 'license' && (
        <BarcodeScanner
          ...
          hint="Move in close so the barcode fills the width of the frame and hold steady — it scans automatically."
      ...
      {scanMode === 'disk' && (
        <BarcodeScanner
          ...
          hint="Hold the vehicle license disk barcode steady inside the frame — it scans automatically."
